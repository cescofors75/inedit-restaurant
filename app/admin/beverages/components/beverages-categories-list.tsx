    ...
    try {
      ...
      if (!response.ok) {
        toast({
          variant: "destructive",
          title: "Error!",
          description: `Failed to update category: ${response.statusText}`,
        });
      ...
      toast({
        ...
        description: `Category "${apiData.name}" has been updated successfully.`,
      });
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Esta acción no se puede deshacer. Si hay bebidas asignadas
              </CardTitle>
              <CardDescription>
                Gestiona las categorías para organizar las bebidas del restaurante
              </CardDescription>
